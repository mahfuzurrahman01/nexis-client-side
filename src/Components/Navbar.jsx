    ...
    return (
        <div className="navbar bg-base-100 my-2">
            ...
            <div className="navbar-end">
                <Link to='/login'><button className='bg-gradient-to-r bg-neutral from-secondary hover:bg-primary hover:bg-gradient-to-l hover:from-secondary text-white duration-500 py-1 px-4 rounded-md'>Sign In</button></Link>
            </div>
        </div>
    );
};
